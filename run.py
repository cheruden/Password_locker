...
# def main():
#     print("Welcome to Cheruiyot password_locker app")
#     while True:
#         print("**************"*10)
#         print("please use the folowing short codes to interact with this application app\n li- login\n cu - Register\n lo -logout")
...
#         while True:
#             print("**********"*10)
#             print("Please use the following short codes to use the Password_locker")
...
#                 break
#             elif user_input =='lo':
#                 print("Thank you for using Cheruiyot Password Locker")
#                 break
